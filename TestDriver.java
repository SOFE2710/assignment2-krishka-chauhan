public class TestDriver
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Test Driver for basic classes.");
        System.out.println(engr1200); //intro to program
        System.out.println(sofe2800); //web program
        System.out.println(sofe2710); //java program
        System.out.println(mece2430); //dynamics
        ...
        john.registerFor(engr1200);    //student
        engr1200.addStudentToCourse(john); //course
        ecse.registerStudentCourseInDepartment(john,engr1200); //dept
        ...
        //Student Jane
        jane.registerFor(mece2430);
        mece2430.addStudentToCourse(jane);
        amme.registerStudentCourseInDepartment(jane,mece2430);

        jane.registerFor(engr1200);
        engr1200.addStudentToCourse(jane);
        ecse.registerStudentCourseInDepartment(jane,engr1200);
